...
public class MainActivity4 extends AppCompatActivity {
    ...
    private final String[] oracionCorrecta = {
            "Los","fragments","reutilizan","partes","de", "pantalla", "en",
            "distintas", "actividades", "de","la", "app"
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cronometro = findViewById(R.id.cronometro4);
        intentosText = findViewById(R.id.intentosText4);
        gridLayout = findViewById(R.id.gridPalabras4);
        resultadoText = findViewById(R.id.resultadoText4);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == android.R.id.home) {
            ...
            finish();
            return true;
        } else if (item.getItemId() == R.id.estadisticas4) {
            // Si el juego estaba activo pero no finalizado, registramos como cancelado
            if (juegoActivo && !juegoFinalizado) {
                registrarJuegoCancelado();
            }
    ...
    private void registrarJuegoCancelado() {
        ...
        String entradaHistorial = "Juego " + (historialJuegos4.size() + 1) + ": Cancelado / Tiempo transcurrido: " + tiempo + " segundos / Intentos: " + intentos;
        historialJuegos4.add(entradaHistorial);
        juegoActivo = false;
    }
    ...
    private void mostrarResultado(boolean gano) {
        ...
        String entradaHistorial = gano
                ? "Juego " + (historialJuegos4.size() + 1) + ": Ganó / Terminó en " + tiempo + " segundos / Intentos: " + intentos
                : "Juego " + (historialJuegos4.size() + 1) + ": Perdió / Terminó en " + tiempo + " segundos";
        historialJuegos4.add(entradaHistorial);
    }
    ...
    public static List<String> historialJuegos4 = new ArrayList<>();
}