...
public class MainActivity3 extends AppCompatActivity {
    ...
    private final String[] oracionCorrecta = {
            "Un","VPN","encripta","tu","conexion", "para", "navegar",
            "de", "forma", "anonima","y", "segura"
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        intentosText = findViewById(R.id.intentosText3);
        gridLayout = findViewById(R.id.gridPalabras3);
        resultadoText = findViewById(R.id.resultadoText3);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == android.R.id.home) {
            ...
            finish();
            return true;
        } else if (item.getItemId() == R.id.estadisticas3) {
            // Si el juego estaba activo pero no finalizado, registramos como cancelado
            if (juegoActivo && !juegoFinalizado) {
                registrarJuegoCancelado();
            }
    ...
    private void registrarJuegoCancelado() {
        ...
        String entradaHistorial = "Juego " + (historialJuegos3.size() + 1) + ": Cancelado / Tiempo transcurrido: " + tiempo + " segundos / Intentos: " + intentos;
        historialJuegos3.add(entradaHistorial);
        juegoActivo = false;
    }
    ...
    private void mostrarResultado(boolean gano) {
        ...
        String entradaHistorial = gano
                ? "Juego " + (historialJuegos3.size() + 1) + ": Ganó / Terminó en " + tiempo + " segundos / Intentos: " + intentos
                : "Juego " + (historialJuegos3.size() + 1) + ": Perdió / Terminó en " + tiempo + " segundos";
        historialJuegos3.add(entradaHistorial);
    }
    ...
    public static List<String> historialJuegos3 = new ArrayList<>();
}